            ...
            <div className="BBHomeIntroWrapper">
                <div className="BBIntroInstructions">
                    ...
                    <div className="BBIntroLinkWrapper">
                        <a href="#" className="BBIntroLink" onClick={() => this.props.setSite(1)}>What buns are there?</a> 
                        <a href="#" className="BBIntroLink" onClick={() => this.props.setSite(2)}>What is Bun Bun Bakery?</a>
                    </div>
                </div>
            </div>
        </div>
